...
public class Opcao {
    ...
    public Opcao(String tituloLocal, List<String> textosEscolhas, boolean acaoCritica) {
    ...
    public Opcao(String tituloLocal, List<String> textosEscolhas, boolean acaoCritica, String nomeLocalReal) {
        this.tituloLocal    = tituloLocal;
        this.textosEscolhas = textosEscolhas != null ? textosEscolhas : new ArrayList<>();
        this.acaoCritica    = acaoCritica;
