...
public class Jogador implements Serializable {
    ...
    public void somarEnergiaDia(int valor) {
    ...
    public void restaurarEnergiaDia() {
        this.energiaDia = ENERGIA_BASE;
    }
    ...
    public boolean temEnergiaDia() {
        return this.energiaDia > 0;
    }
    ...
    //GETs
    public int getDesempenho_EXA() {
        return desempenho_academico_EXA;
    }
    ...
    public int getDesempenho_TEC() {
        return desempenho_academico_TEC;
    }
    ...
    public int getDesempenho_ALG() {
        return desempenho_academico_ALG;
    }
